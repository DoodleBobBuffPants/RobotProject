...
\begin{document}
	...
	% Changed this to not mention any implementation details in background section
	% the original paper refer to the output of each motor schema as a vector so i've only referred to 'velocity' in reference to robot control input
	...
	% i think experimental setup makes more sense in approach than introduction because its part of the implementation
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	% References don't count in the 4 page count
