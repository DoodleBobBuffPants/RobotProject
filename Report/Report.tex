...
Different referencing schemes exist to find $F_i$. Unit-Center computes the average $P_R$ as the center of the formation, Leader-Referencing defines the formation relative to a leader robot's pose, and Neighbor-Referencing defines each robot's position relative to a predefined neighbor.
